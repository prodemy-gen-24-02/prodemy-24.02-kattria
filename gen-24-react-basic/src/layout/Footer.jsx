...
import { faBriefcase, faCircleQuestion, faGift } from '@fortawesome/free-solid-svg-icons'
            ...
            <div className="container flex justify-between items-center ">
                <div className="flex space-x-4 font-semibold">
                    <a href="" className="space-x-2  hover:text-red-600">
                        <FontAwesomeIcon icon={faBriefcase} className="text-[24px] text-red-400"/>
                        <span >Become Seller</span>
                    </a>
                    <a href=""className="space-x-2  hover:text-red-600">
                        <FontAwesomeIcon icon={faGift} className="text-[24px] text-red-400"/>
                        <span>Gift Cards</span>
                    </a>
                    <a href="" className="space-x-2  hover:text-red-600">
                        <FontAwesomeIcon icon={faCircleQuestion} className="text-[24px] text-red-400"/>
